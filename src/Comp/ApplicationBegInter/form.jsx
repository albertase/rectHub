...
const Form = () => {
    ...
    const sendFormData = async (data) => {
        try {
            ...
            const response = await axios.post("/subscriber/sendmessage", data);
                        ...
                        <Forms onSubmit={handleSubmit}>
                            <Grid gtc="repeat(2, 1fr)" gap="40px" formGap>
                                ...
                                <Container appForms>
                                    ...
                                    <PhoneNumberValidation name="phone" phoneValue={formData.phoneNo} phoneChange={handleChange}/>
                                </Container>
                                <Container appForms>
                                    <Label>Gender</Label>
                                    <Selects name="gender" value={formData.gender} onChange={handleChange}>
